...
namespace WebFinally
{
    public partial class information : System.Web.UI.Page
    {
        ...
        protected void GetData(object sender, GridViewDeleteEventArgs e)
        {
            string s_str = ConfigurationManager.ConnectionStrings["WebSQL"].ConnectionString;
            try
            {
                SqlConnection connection = new SqlConnection(s_str);
                DataSet ds = new DataSet();
                SqlDataAdapter da = new SqlDataAdapter("Select * from Cus", connection);
                da.Fill(ds);
