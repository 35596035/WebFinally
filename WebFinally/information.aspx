...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br />
            <asp:GridView ID="gv_Show" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="inf" OnRowDeleting="GetData" CellSpacing="2" >
                <Columns>
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
